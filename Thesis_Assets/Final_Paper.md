...
| Authors / Year | Title | Objectives | Methodology / Findings | Contribution to This Thesis |
|---|---|---|---|---|
| Bertolini et al., 2020 [10] | Modeling disease progression in mild cognitive impairment and Alzheimer's Disease with digital twins | Generate synthetic "Digital Twin" clinical records predicting standard-of-care disease progression | Conditional Restricted Boltzmann Machines modeling MMSE/ADAS-Cog trajectories over time (ADNI & CODR-AD datasets) | Direct validation of the AD-focused, simulative DT concept this work adopts |
